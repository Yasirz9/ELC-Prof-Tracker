...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ELC Prof Tracker — submit and manage payment proofs securely." },
      { name: "author", content: "ELC" },
      { property: "og:title", content: "ELC Prof Tracker" },
      { property: "og:description", content: "ELC Prof Tracker — submit and manage payment proofs securely." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@ELC" },
      { name: "twitter:title", content: "ELC Prof Tracker" },
      { name: "twitter:description", content: "ELC Prof Tracker — submit and manage payment proofs securely." },
